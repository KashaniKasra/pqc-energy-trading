...
The next midpoint `sustained-230-v1_ecdsa` probe failed as well: 13,621/13,801 requests succeeded, so `tx_success_rate=0.986957467` failed its gate even though successful throughput was 227.016667 TPS (`0.987029` of offered) and latency remained stable. Its reproducible result is retained in `data/e1_ecdsa_sustainability_230.csv` (SHA-256 `05050cb10b3dd83774bbdc67de5ab12089e810c0c9913b28c9aaf368676267f5`). The current ECDSA bracket is `[224,230]`; `benchmark_ecdsa_sustained_227.yaml` is the next immutable integer-midpoint probe, with a discarded 20-second 50-TPS warm-up and one 60-second round at 227 TPS.
