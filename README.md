...
The `sustained-227-v1_ecdsa` midpoint passed: 13,509/13,621 requests succeeded, giving `tx_success_rate=0.991777403` and successful throughput 225.150000 TPS (`0.991850` of offered), while latency remained stable. Its reproducible result is retained in `data/e1_ecdsa_sustainability_227.csv` (SHA-256 `19fdc0ef20a2d6e8bad308755c4a3abac8b22ebe399798c3995c6927dcd3ee2a`). The current ECDSA bracket is `[227,230]`; `benchmark_ecdsa_sustained_228.yaml` is the next immutable integer-midpoint probe, with a discarded 20-second 50-TPS warm-up and one 60-second round at 228 TPS.
