...
The midpoint `sustained-237-v1_ecdsa` probe also failed: 13,750/14,221 requests succeeded, so `tx_success_rate=0.966879966` failed its gate even though successful throughput was 229.166667 TPS (`0.966948` of offered) and latency remained stable. Its reproducible result is retained in `data/e1_ecdsa_sustainability_237.csv` (SHA-256 `918c6c3ec5062e457b239768068a54ccc6145f92ec0d91cfdb031e607e61382e`). The current ECDSA bracket is `[224,237]`; `benchmark_ecdsa_sustained_230.yaml` is the next immutable integer-midpoint probe, with a discarded 20-second 50-TPS warm-up and one 60-second round at 230 TPS.
